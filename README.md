...
O ecossistema conta com uma interface **SOTA (State-of-the-Art)** constru�da em Streamlit com design Glassmorphism, que atende tanto � simula��o micro (aluno individual) quanto � gest�o macro (Clusters K-Means).

### ?? Simulador com Explicabilidade Din�mica (SHAP)
Na primeira aba, o usu�rio testa par�metros (Frequ�ncia Escolar, PIB, etc) e a IA responde em tempo real com o risco de evas�o, al�m de gerar uma auditoria gr�fica individual.

![Simulador de Predi��o](images/print_simulador.png)
![SHAP Din�mico](images/print_shap.png)

### ??? Vis�o Macroestrat�gica (Clusters e KPIs)
Na segunda aba, os governantes t�m acesso a um mapa de calor interativo cruzado com os algoritmos de clusteriza��o para tomada de decis�o federal.
